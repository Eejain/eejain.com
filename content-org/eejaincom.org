...
* A pond and a river :@Life:literature:poem:
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
:EXPORT_FILE_NAME: a pond and a river
...
#+include: "~/Dropbox/MarkdownNotes/MDNotes/hu saids.org::*a pond and a river" :only-contents t
...
* My Reference Management Workflow with Zotero :@Academic:productivity:
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
...
#+include: "/Users/naskuv/GoogleDrive/MarkdownNotes/MDNotes/my reference literature management workflow.org" :only-contents t

* A Quick Comparison between Zotero and Citavi :@Academic:productivity:
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
...
#+include: "/Users/naskuv/GoogleDrive/MarkdownNotes/MDNotes/compare zotero and citavi.org" :only-contents t

* My Academic Reading Workflow :@Academic:productivity:
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
...
#+include: "/Users/naskuv/GoogleDrive/MarkdownNotes/MDNotes/my academic reading workflow.org" :only-contents t

* Notes on Citation Syntax :@Academic:productivity:
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
...
#+include: "/Users/naskuv/GoogleDrive/MarkdownNotes/MDNotes/Citation Syntax.md" :only-contents t
* My Doom Emacs Configuration :@Meta:technology:
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
...
* CANC 目色 :@FanFic:manga:
CLOSED: [2020-09-23 Wed 14:59]
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
:EXPORT_FILE_NAME: 目色
...
* CANC Inferno pt.2 :@FanFic:manga:
CLOSED: [2020-09-24 Thu 10:15]
:PROPERTIES:
:EXPORT_HUGO_SECTION: posts
...
- State "CANC"       from "TODO"       [2020-09-24 Thu 10:15]
...
只属于我一个人的恋情在四年的长度上展开
* CANC RSS, a mild intro :technology:
CLOSED: [2020-11-10 Tue 10:08]

- State "CANC"       from "TODO"       [2020-11-10 Tue 10:08]
- State "TODO"       from              [2020-09-09 Wed 11:04]
