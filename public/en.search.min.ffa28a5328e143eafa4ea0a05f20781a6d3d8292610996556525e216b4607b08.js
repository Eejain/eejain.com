...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.98d3fd7c3518dcedab8848b641707ae0a130e4f805d587ffa0987bf3736a6d17.js',function(){input.required=false;search();});}
