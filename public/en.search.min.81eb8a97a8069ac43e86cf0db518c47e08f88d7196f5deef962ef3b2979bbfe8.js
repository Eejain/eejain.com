...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.52600cec5d3b7dc0ace62aa70cc997eb39c76bcc438fd8247ef3323ac01fb6cc.js',function(){input.required=false;search();});}
